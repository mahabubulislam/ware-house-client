                    ...
                    <div className='my-10'>
                        ...
                        <div className='flex flex-col justify-center items-center py-5 '>
                            ...
                            <div className='p-3'>
                                ...
                                <p><span className='font-bold'>Quantity:</span> {newQuantity}</p>
                                <button onClick={decreaseQuantity} className='bg-blue-300 hover:bg-blue-600 text-white p-2 rounded-md'>Delevered</button>
                                <form onSubmit={handleRestock}>
                                    <input type="number" name="stock" min="0" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500  rounded-md sm:text-sm focus:ring-1" placeholder="Restock" />
                                    <input type="submit" value="Restock" className='bg-red-300 p-2 rounded-md '/>
                                </form>
                            </div>
                        </div>
